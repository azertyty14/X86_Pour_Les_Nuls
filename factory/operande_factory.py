        ...
        if val[0] == "0":
            ...
            if len(a) == 1:
                if a[0][0] == "0":
                    ...
                    return MemoryOperande("null", "null", 0, -int(a[0][1:], base=16))
                elif '*' in a[0]:
                    b = a[0].split('*')
                ...
                if '*' in a[0]:
                    ...
                    if a[1][0] == "0":
                        ...
                        return MemoryOperande("null", b[0], int(b[1], base=16), -int(a[1][1:], base=16))
                elif '*' in a[1]:
                    b = a[1].split('*')
                    ...
                    if a[1][0] == "0":
                        ...
                        return MemoryOperande(a[0], "null", 0, -int(a[1][1:], base=16))
            else:
                b = a[1].split('*')
                if a[2][0] == "0":
                    return MemoryOperande(a[0], b[0], int(b[1], base=16), int(a[2], base=16))
                else:
                    return MemoryOperande(a[0], b[0], int(b[1], base=16), -int(a[2][1:], base=16))         
        elif val[0] == '@':
